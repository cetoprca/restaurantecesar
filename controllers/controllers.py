...
class RestauranteController(http.Controller):
    ...
    @http.route('/api/mesa/add', auth='public', type='json', methods=['POST'])
    def addMesa(self, **kw):
    ...
    @http.route('/api/mesa/update', auth='public', type='json', methods=['POST'])
